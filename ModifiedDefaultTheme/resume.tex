...
\begin{cventries}
	...
	{\def\arraystretch{1.25}{\begin{tabular}{ l l }
		...
		\vspace{0.4mm}
		Technologies/Frameworks:  & {\skill{ \begin{tabular}{ll} Spring, Hibernate, J2EE, flask, Node.js, RabbitMQ, MVC, AWS Lambda, Kafka, Zookeeper, REST, \\GraphQL, SOAP, gRPC, proto buffer\end{tabular}}} \\
		\vspace{0.4mm}
		...
		\vspace{0.4mm}
		Design \& Development:  & {\skill{ Agile, Scrum, Design Patterns, OAuth2}} \\
		\end{tabular}}}
	{}
	{}
	{}
